...
class DeviceTest {
  ...
  gatherDeviceData() {
    ...
    const featuresToDetect = ["pointer:none", "pointer:coarse", "pointer:fine", "hover:none", "hover:hover", "any-pointer:none", "any-pointer:coarse", "any-pointer:fine", "any-hover:none", "any-hover:hover"];
  ...
  renderDeviceInfo() {
    const container = this.container.querySelector('#deviceinfo'); //[{key, value},{key, value}] -> [ {key}, {value}, {key}, {value} ]
